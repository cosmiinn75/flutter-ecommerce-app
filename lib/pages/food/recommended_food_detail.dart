              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                      ...
                      child: AppIcon(iconData: Icons.remove , backgroundColor: AppColors.mainColor,iconColor: Colors.white,iconSize: 24,)),
                  BigText(text: "\$${product.price!} X ${controller.inCartItems}", size: 24, color: AppColors.mainBlackColor,),
                  GestureDetector(
                      onTap: () {
                        controller.setQuantity(true);
                      },
                      child: AppIcon(iconData: Icons.add , backgroundColor: AppColors.mainColor, iconColor: Colors.white, iconSize: 24))
                ],
              ),
            ),
            Container(
